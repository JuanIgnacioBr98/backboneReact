...
import { ICendeuGateway } from "../../../src/modules/Cendeu/core/gateways/ICendeuGateway";
...
export const cendeuGatewayMock = mock<ICendeuGateway>();
...
export const updateFileStatusGatewayMock = mock<IUpdateFileStatusGateway>();
export const fileName = "FileTest.txt";
...
export const updateFileResponse = {
  ...
  data: {
    ...
    processed_rows: 0,
    fail_rows: 999,
    error_file_name: "error_logs_cendeu.txt",
